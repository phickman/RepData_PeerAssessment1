...
The impact of imputing missing data on the estimates of the total daily number of steps is small.  The missing values are for whole days rather than random intervals through the whole dataset.  As a result the imputed data inserts daily averages, which results in no change to the overall daily average.  However, the change has slightly increased the median.
